...
<body>
    ...
    <div class="container content">
        <p class="heading p-1">Edit Employee Details</p>
        
    	<form action="update_emp/${id }" autocomplete="on" method="post">
        <div class="row">
            <div class="col-sm-6 text-right p-3">
                <label for="code">Employee Code:</label>
            </div>
            <div class="col-sm-6 text-left p-3">
                <input type="number" id="quantity" name="empCode" maxlength="500" value=${id } readonly>
            </div>
